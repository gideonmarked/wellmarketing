...
class TNMadmin extends CI_Controller {
	...
	public function tickets($password)
	{
		$data['title'] = 'Show Tickets';
		if($this->session->userdata('logged_in') && $this->session->userdata('username') == 'tnmadmin' && $password == 'chocolatemocha'):
	...
	public function ticket_owners()
	{
		$data['title'] = 'Show Ticket Owners';
		$this->load->view('templates/header', $data);
		if($this->session->userdata('logged_in') && $this->session->userdata('username') == 'tnmadmin'):
			$this->administrator_model->get_ticket_owners();
		else:
			$data['badmessage'] = 'You must be logged in to view this page.';
			$this->load->view('account/login', $data);
		endif;
